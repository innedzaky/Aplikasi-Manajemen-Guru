            ...
            <div className="flex items-center gap-2 self-end lg:self-auto flex-wrap">
              ...
              {hasActiveFilters && (
                <button
                  ...
                  className="px-3 py-2 rounded-xl text-xs font-semibold bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-800 hover:bg-rose-100 transition-colors flex items-center gap-1.5 cursor-pointer"
                >
