      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-emerald-600 dark:bg-emerald-700 flex items-center justify-center text-white shadow-xs">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-6">
          ...
          <div>
            <p className="px-3 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-2.5">
              Menu Utama
            </p>
              ...
              {mainMenuItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-[13.5px] sm:text-sm font-medium transition-all group ${
                      isActive
          ...
          {/* Master Data Section */}
          <div>
            <p className="px-3 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-2.5 flex items-center justify-between">
