    ...
    <div className="space-y-4">
        ...
        actions={
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-700 text-white shadow-xs transition-colors flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
      ...
      <div className="p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 flex flex-wrap items-center justify-between gap-2 text-xs">
        <div className="flex flex-wrap items-center gap-2">
          <span className="text-slate-400 font-semibold">Rekap Hasil Filter:</span>
          ...
          <span className="px-2.5 py-0.5 rounded-full font-bold bg-purple-100 dark:bg-purple-950/80 text-purple-700 dark:text-purple-300">
            Sakit: {stats.sakit}
          </span>
          <span className="px-2.5 py-0.5 rounded-full font-bold bg-rose-100 dark:bg-rose-950/80 text-rose-700 dark:text-rose-300">
            Alpa: {stats.alpa}
          </span>
        </div>
        ...
        {filteredRecords.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <button
              ...
              className="mt-3 px-4 py-1.5 rounded-xl text-xs font-semibold bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 hover:bg-blue-100 transition-colors inline-flex items-center gap-1.5 cursor-pointer"
            >
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3 px-4">
                        ...
                        <div className="text-[11px] text-blue-600 dark:text-blue-400 font-bold font-mono">
                      ...
                      <td className="py-3 px-4 text-center">
                        <span
                          className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-bold border ${badgeClass}`}
                        >
