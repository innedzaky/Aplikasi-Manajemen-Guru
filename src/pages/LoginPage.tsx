/**
 * =========================================================================
 * LoginPage.tsx - Modern Minimalist Authentication Page (Slate & Emerald)
 * =========================================================================
 */
...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex bg-slate-50 dark:bg-slate-950 font-sans text-slate-800 dark:text-slate-100 transition-colors">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 border-r border-slate-800 p-12 text-white flex-col justify-between relative overflow-hidden">
        {/* Abstract Background Accent */}
        <div className="absolute -right-20 -top-20 w-96 h-96 bg-emerald-500/10 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute -left-20 -bottom-20 w-96 h-96 bg-emerald-700/10 rounded-full blur-3xl pointer-events-none" />

        {/* Top Logo */}
        <div className="flex items-center gap-3 z-10">
          <div className="w-11 h-11 rounded-xl bg-emerald-600/20 border border-emerald-500/30 flex items-center justify-center shadow-xs">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Aplikasi Presensi, Nilai & Jurnal Kelas</p>
          </div>
        </div>
        ...
        <div className="z-10 max-w-lg space-y-8 my-auto">
          <div className="space-y-3">
            ...
            <h2 className="text-3xl xl:text-4xl font-extrabold tracking-tight leading-tight text-white font-['Outfit']">
              Kelola Presensi, Nilai &amp; Jurnal Kelas Lebih Cepat dan Rapi.
            </h2>
          ...
          <div className="grid grid-cols-1 gap-4 pt-2">
            <div className="flex items-center gap-3.5 p-3 rounded-xl bg-slate-800/60 border border-slate-700/60 backdrop-blur-xs">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Simpan status kehadiran seluruh siswa per kelas secara cepat.</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3.5 p-3 rounded-xl bg-slate-800/60 border border-slate-700/60 backdrop-blur-xs">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Dokumentasikan materi dan capaian pembelajaran secara terstruktur.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Bottom Status */}
        <div className="z-10 flex items-center justify-between text-xs text-slate-400 border-t border-slate-800 pt-6">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white placeholder-slate-400 text-sm focus:outline-hidden focus:ring-2 focus:ring-emerald-600 focus:border-transparent transition-all shadow-xs"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-11 pr-11 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white placeholder-slate-400 text-sm focus:outline-hidden focus:ring-2 focus:ring-emerald-600 focus:border-transparent transition-all shadow-xs"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                <input
                  ...
                  className="w-4 h-4 text-emerald-600 border-slate-300 dark:border-slate-700 rounded-md focus:ring-emerald-500 accent-emerald-600"
                />
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-emerald-700 hover:bg-emerald-800 active:bg-emerald-900 disabled:bg-emerald-400 text-white font-medium rounded-xl shadow-xs transition-all text-sm cursor-pointer"
            >
              {isSubmitting ? (
